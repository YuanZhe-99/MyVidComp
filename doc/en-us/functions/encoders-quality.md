# Encoders and quality estimation

Finding encoders that actually work, ordering the attempts for one file, and estimating a quality
setting without test encodes. Described for readers in [../encoders.md](../encoders.md).
